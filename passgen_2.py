...
# ADD DICT FOR SOUND EFFECT FILES
# click, tab, save, error, etc

# PLAYSOUND FUNCTION
# in every element command - unless there's another way
# one param: sound
# if sounds are toggled: look at param and get that wav/mp3 file from dict
